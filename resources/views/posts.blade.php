<!-- Untuk melihat isi dari variable => $dd -->
<!-- $dd($post) -->
    ...
    <div class="card-body text-center">
        ...
        <p>
            <small class="text-muted">
                By. <a href="/authors/{{ $posts[0]->author->username }}" class="text-decoration-none">{{ $posts[0]->author->name }}</a> in <a href="/categories/{{ $posts[0]->category->slug }}" class="text-decoration-none">{{ $posts[0]->category->name }}
...
@else
<p clas="text-center fs-4">No post found..</p>
@endif
